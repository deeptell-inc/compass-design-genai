...
import { figmaProjects } from "@/services/mockData";
...
import FigmaMCPPage from "./FigmaMCPPage";
import { Key, Save, Eye, EyeOff, Figma, Upload, BarChart3 } from 'lucide-react';
...
const FigmaPage = () => {
  ...
  const handleProjectImport = (projectId: string) => {
    toast({
      title: "インポート開始",
      description: `プロジェクト ${projectId} のインポートを開始しました`,
    });
  };
  ...
  return (
    <MainLayout>
      <div className="container mx-auto p-6 space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Figma統合</h1>
          <p className="text-gray-600 mt-2">
            FigmaデザインファイルとCOMPASS Design GenAIを連携させましょう
          </p>
        </div>
